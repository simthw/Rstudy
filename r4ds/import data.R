...
penguins_Tor <- read_excel("data/penguins.xlsx", sheet = "Torgersen",
                           na = "NA")
penguins_Bis <- read_excel("data/penguins.xlsx", sheet = "Biscoe",
                           na = "NA")
penguins_Dre <- read_excel("data/penguins.xlsx", sheet = "Dream",
                           na = "NA")
